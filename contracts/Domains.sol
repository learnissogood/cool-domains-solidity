...
contract Domains is ERC721URIStorage {
    ...
    // We'll be storing out NFT images on chain as SVGs
    ...
    constructor(string memory _tld) payable ERC721("Fresh Name Service", "FRESH") {
    ...
    function withdraw () public onlyOwner {
        ...
        require(succes, "Failed to withdraw Matic");
    }
    ...
    function _price (string calldata name) private pure returns (uint) {
    ...
    // This function will give us the domain owners address
    function getAddress (string calldata name) public view returns (address domain) {
        domain = domains[name];
    }

    function setRecord (string calldata name, string calldata record) public {
        // Chequing that the owner is the transaction sender
